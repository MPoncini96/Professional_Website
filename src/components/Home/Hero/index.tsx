      ...
      <div className='relative z-10 mx-auto max-w-7xl px-6 sm:px-8 xl:px-0'>
        <div className='grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center'>
          <div className='text-left'>
            ...
            <h1 className='xl:text-heading-1 mb-6 text-3xl font-extrabold text-white sm:text-3xl'>
              Matthew Poncini: Designer, Developer, Creator
            </h1>

            <p className='mb-9 max-w-[500px] font-medium md:text-lg'>
              Crafting digital experiences that blend creativity and technology.  Experienced in optimization for performance and user engagement.
            </p>
          ...
          <div
            className='relative mx-auto h-56 w-56 overflow-hidden rounded-full sm:h-64 sm:w-64 lg:h-72 lg:w-72'
            data-wow-delay='0.1s'
          >
            <Image
              className='object-cover rounded-full'
              src='/images/hero/marathon.jpeg'
              alt='avatar'
              fill
